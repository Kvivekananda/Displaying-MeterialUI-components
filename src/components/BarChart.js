...
const male = [60, 50, 44, 98, 65, 24];

const female = [45, 54, 87, 65, 50, 19];
      ...
      <Box sx={{ p: 4, minHeight: "100vh" }}>
        ...
        <Box sx={{ p: 3, my: 12 }}>
          <Box sx={{ mb: 5 }}>
            ...
            <Typography variant="body1" color="text.secondary" gutterBottom>
              Below shows Pyramid BarChart Of Male and Female of Each Department
            </Typography>
          </Box>
          <Card>
            <CardContent>
