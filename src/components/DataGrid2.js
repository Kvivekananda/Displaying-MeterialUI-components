...
export default function FullFeaturedCrudGrid() {
  ...
  return (
    <div>
      <Box sx={{ p: 2, bgcolor: "#f5f5f5", mb: 2, borderRadius: 1,padding:'40px' }}>
      ...
      <div style={{ padding: "25px" }}>
        ...
        >
          <Box sx={{ p: 2, bgcolor: "#f5f5f5", mb: 2, borderRadius: 1 }}>
            ...
            <Typography variant="body2" color="text.secondary">
              The Data Grid can only sort the rows according to one criterion at
              a time.
            </Typography>
          </Box>
          <DataGrid
            ...
            initialState={{
              ...
              pagination: { paginationModal: { pageSize: 25 } },
            }}
