...
export default function FeedbackPage() {
  ...
  return (
    <div>
      ...
      >
        ...
        <Typography variant="body1" color="text.secondary">
          ...
          Feedback and Surfaces component.
        </Typography>
      </Box>
    <div style={{ padding: "20px" }}>
          ...
          >
            ...
            <DialogContent>
              <DialogContentText id="alert-dialog-description">
                Before submitting your feedback, you can review the team’s task
                status. Check which tasks are in draft, ready to deploy,
                completed, or blocked. This helps you provide more informed
                feedback about team collaboration and performance.
              </DialogContentText>
            </DialogContent>
            <DialogActions>
      ...
      <Stack spacing={2}>
        <Box style={{ marginTop: "60px", marginBottom: "10px" }}>
          {" "}
        ...
        <Typography variant="body">
          You can view each team member’s task status before submitting your
          feedback by pressing the button below.
        </Typography>
      ...
      <Stack direction="row" spacing={2}>
        <Card sx={{ maxWidth: 345, mt: 3 }}>
          ...
          <CardContent>
            ...
            <Typography variant="body2" sx={{ color: "text.secondary" }}>
              I think our project is going well. I am happy with the
              collaboration within the team, but I feel we can improve our task
              tracking so nothing gets delayed. Personally, I am learning a lot
              and want to contribute more to optimize our development process
            </Typography>
          </CardContent>
          <CardActions>
        ...
        <Card sx={{ maxWidth: 345, mt: 3 }}>
          ...
          <CardContent>
            ...
            <Typography variant="body2" sx={{ color: "text.secondary" }}>
              I am satisfied with how the team is performing. Everyone is
              supportive, and the tasks are clear. I believe we can improve by
              sharing knowledge more openly, especially for new members.
            </Typography>
          </CardContent>
          <CardActions>
            <Button size="small">Share</Button>
        ...
        <Card sx={{ maxWidth: 345, mt: 3 }}>
          ...
          <CardContent>
            ...
            <Typography variant="body2" sx={{ color: "text.secondary" }}>
              Managing multiple tasks has been challenging, but I enjoy working
              on complex problems. I think the team could benefit from more
              planning upfront to avoid last-minute rushes.
            </Typography>
          </CardContent>
          <CardActions>
            <Button size="small">Share</Button>
